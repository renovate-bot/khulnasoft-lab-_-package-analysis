...
import (
	...
	"github.com/khulnasoft-lab/package-analysis/internal/staticanalysis/signals"
	"github.com/khulnasoft-lab/package-analysis/pkg/api/staticanalysis"
	"github.com/khulnasoft-lab/package-analysis/pkg/api/staticanalysis/token"
	"github.com/khulnasoft-lab/package-analysis/pkg/valuecounts"
)
			...
			result: Result{Files: []SingleResult{
				{
					...
					Parsing: &parsing.SingleResult{
						...
						StringLiterals: []token.String{
							...
							{
								Value:   "https://github.com/khulnasoft-lab/package-analysis",
								Raw:     `"https://github.com/khulnasoft-lab/package-analysis"`,
								Entropy: 0.2,
							},
							{
								Value:   "192.168.0.1",
					...
					Signals: &signals.FileSignals{
						...
						URLs:          []string{"https://github.com/khulnasoft-lab/package-analysis"},
					},
				},
			}},
			want: &staticanalysis.Results{Files: []staticanalysis.FileResult{
